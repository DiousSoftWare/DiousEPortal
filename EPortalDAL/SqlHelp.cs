...
namespace EPortalDAL
{
    ...
    public abstract class SqlHelper
    {
       public static string connectionString ="";
        ...
        //public static void InitConConfig()
        //{
        //    //指定config文件读取
        //    string file = System.Windows.Forms.Application.ExecutablePath;
        //    System.Configuration.Configuration config = ConfigurationManager.OpenExeConfiguration(file);
        //    string connectionString1 =config.ConnectionStrings.ConnectionStrings["Sql"].ConnectionString;
        ...
        public static int ExecteNonQuery1(SqlCommand Cmd,CommandType cmdType, string cmdText, params SqlParameter[] commandParameters)
        {
